        ...
        <div class="row">
            <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
                <div class="testimony-39291">
                    ...
                    <div class="d-flex vcard align-items-center">
                        <div class="pic mr-3">
                            <img src="<?= base_url(); ?>assets/images/person_3_sq.jpg" alt="Image" class="img-fluid">
                        </div>
                        <div class="text">
            ...
            <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
                <div class="testimony-39291">
                    ...
                    <div class="d-flex vcard align-items-center">
                        <div class="pic mr-3">
                            <img src="<?= base_url(); ?>assets/images/person_4_sq.jpg" alt="Image" class="img-fluid">
                        </div>
                        <div class="text">
                            <strong class="d-block">John Doe</strong>
                            <span>CEO and Co-Founder</span>
...
<div class="site-section bg-image overlay" style="background-image: url('<?=base_url(); ?>/assets/images/hero_2.jpg');">
    <div class="container">
